...
Currently, the `dr()` function works for the following methods that require data matrix (or data frame).

+ `stats::prcomp()`
+ `Rtsne::Rtsne()`

And works for the following methods that require distance matrix (or distance object).
